<template>
  <div class="container">
    <div class="main-register">
      <div class="main-register-left">
        <div class="container-register">
          <div class="main-register-left__title">Регистрация</div>
          <RegisterComponent @isLoadingBehavior="loadingBehaviorNeed" />
        </div>
      </div>
      <div class="main-register-right">
        <div class="main-register-right__title">Авторизация</div>
        <form
          class="main-register-right__form"
          @submit.prevent="authorizationSubmitForm"
        >
          <div class="main-register-right__form_login">
            <input
              type="text"
              class="main-register-right__form_login_input"
          ...
          <div class="main-register-right__form_password">
            <input
              class="main-register-right__form_password_input"
              type="password"
          ...
          <div class="main-register-right__form_options">
            <router-link to="/recovery">Забыли пароль?</router-link>
            <router-link to="/register">Регистрация</router-link>
          </div>
          <div class="main-register-right__form_btn">
            <button
              type="submit"
